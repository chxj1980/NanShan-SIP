#pragma once
#ifdef _FOR_RTS_USE
#define _PS_ANALYZE_USE
#define _HEVC2AVC_USE
...
public:
	...
	virtual bool alarm_startCapture(int nPort, LPALARMCALLBACK lpCallBack);
	virtual bool alarm_stop();
...
public:
	...
	void reconnect();
	bool sendKeyFrame(unsigned char * buffer, unsigned int bufsize);
public:
	int m_nWindlt;
	int m_nWindrb;
	int m_nSrcWidth;
	...
	std::vector<REC_FILE>	m_vecPlayBack;
#ifdef _PLAY_PLUGIN
