...
#define CAMERA_LOCK          16       //云台锁定
#define CAMERA_UNLOCK        17       //云台解锁

#define CAMERA_INITIAL		 18       //守望		nSpeed 字节1 预置位 字节23 时间(秒)
#define CAMERA_UNINITIAL	 19		  //停止守望
#define CAMERA_PAN_LU		 20       //云台左上
#define CAMERA_PAN_LD		 21		  //云台左下
#define CAMERA_PAN_RU		 22       //云台右上
#define CAMERA_PAN_RD	     23       //云台右下

#define CAMERA_SETP          24		  //窗口定位，使用nSpeed参数设置原窗口坐标		
#define CAMERA_SETN		     25       //窗口定位，使用nSpeed参数设置定位窗口坐标

#define CAMERA_3D_FIRST		 26	      //3D定位  nSpeed 字节1 left/10 字节2 top/10 字节3 right/10 字节4 bottom/10
#define CAMERA_3D_SECOND	 27	      //3D定位
...
//云台巡航
#define PTZ_CRUISE_ADD		 28       //加入巡航点	nIndex 字节1 巡航号 字节2 预置位
#define PTZ_CRUISE_DEL		 29       //删除巡航点	nIndex 字节1 巡航号 字节2 预置位
#define PTZ_CRUISE_TIME		 30		  //巡航停顿时间	nIndex 字节1 巡航号 字节23 停顿时间
#define PTZ_CRUISE_LOOP	     31       //启动巡航		nIndex 字节1 巡航号
#define PTZ_CRUISE_STOPL     32       //停止巡航		nIndex 字节1 巡航号
...
#define REPLAY_CTRL_PLAYSETTIME		 25
